...
namespace ServoPress.Services
{
    ...
    public partial class ArtDAQ
    {
        ...
        //ArtDAQ Attributes 
        //***********************************************************
        public const UInt32 DAQ = (1 << 0);
        public const UInt32 Scope = (1 << 1);
        public const UInt32 Switch = (1 << 2);
        public const UInt32 DMM = (1 << 3);
        ...
        public const Int32 ArtDAQ_Cal_AIOffset = 0x1001;
        public const Int32 ArtDAQ_Cal_AICodeWidth = 0x1002;
        public const Int32 ArtDAQ_Cal_AIBridgeNulloffset = 0x1011;
        public const Int32 ArtDAQ_Cal_AIBridgeShuntGain = 0x1012;
        public const Int32 ArtDAQ_Cal_AOOffset = 0x2001;
        public const Int32 ArtDAQ_Cal_AOCodeWidth = 0x2002;
        ...
        public const Int32 ArtDAQ_Exported_PositionComparsionEvent_PulseWidthMode = 0x2973; // Specifies the pulse width of the pulses at the output terminal of the counter when Output Behavior is ArtDAQ_Val_Pulse. ART-DAQ ignores this property if Output Behavior is ArtDAQ_Val_Toggle.
        public const Int32 ArtDAQ_Exported_FrequenceOutput_OutputTerm = 0x2974;
       ...
       ******************************************************************************/
        ...
        /********************System Property****************************/
        [StructLayout(LayoutKind.Sequential, Pack = 1, CharSet = CharSet.Ansi)]
        public struct DMCSCSL_DEV_NODE
        {
            ...
            public UInt32 slotInfo;
            public UInt32 DevNodeStatus;
        }

        [DllImport("DMCSCSL_32.DLL", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern Int32 DMCSCSL_GetDeviceList(UInt32 devClass, IntPtr buffer, Int32 bufferSize, ref Int32 devCount);

        [DllImport("DMCSCSL_32.DLL", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern Int32 DMCSCSL_RenameDevice(string deviceName, string newName);
        ...
        [DllImport("Art_DAQ.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern Int32 ArtDAQ_GetCharCalInfoAttributeF64(IntPtr taskHandle, string channel, Int32 attribute, out double value);



        [DllImport("Art_DAQ.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern Int32 ArtDAQ_ResetChanCalInfoAttribute(IntPtr taskHandle, string channel, Int32 attribute);
        ...
        [DllImport("Art_DAQ.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern Int32 ArtDAQ_GetChanCalInfoAttributeF64(IntPtr taskHandle, string channel, Int32 attribute, out double value);

        [DllImport("Art_DAQ.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern Int32 ArtDAQ_GetSelfCalLastDateAndTime(string deviceName, ref UInt32 year, ref UInt32 month, ref UInt32 day, ref UInt32 hour, ref UInt32 minute);
        ...
        ******************************************************************************/
        ...
        [DllImport("Art_DAQ.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern Int32 ArtDAQ_GetSampTimingType(IntPtr taskHandle, Int32 attribute, IntPtr value, Int32 bufferSize);
